...
Did Berlin do well in imposing a rental ceiling to keep housing affordable? 
...
```{r Diff_in_Diff_output, include=FALSE}
...
The table above shows the difference in difference estimation. 
